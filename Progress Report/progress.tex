...
\large{\textbf{\verb=public class GPSdebug extends Activity=}}
...
\large{\textbf{\verb=public class GPSservice extends Service=}}
...
\verb=public int onStartCommand(Intent intent, int flags, int startID)=
